...
{
	echo exec("sudo bash /home/diegocamargo/startVlans.sh");
	echo ("vLans iniciadas");
}
if (isset($_POST['stopvlans']))
{
	echo exec("sudo bash /home/diegocamargo/stopVlans.sh");
	echo ("vLans detenidas");
}
if (isset($_POST['shareInternet']))
{
	echo exec("sudo bash /home/diegocamargo/startPAT.sh");
